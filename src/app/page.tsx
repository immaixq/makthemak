...
export default function Home() {
  ...
  >
    <section className='mx-auto'>
      <div className='flex'>
      <h1 className='font-bold text-4xl md:text-5xl font-serif'>Hello, I&apos;m Mai 👋</h1>
