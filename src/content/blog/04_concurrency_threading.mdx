...
Time-sharing systems were a significant milestone in enabling concurrency, as they introduced the concept of multiple users interacting with the computer at the same time. 
